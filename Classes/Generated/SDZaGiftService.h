...
@interface SDZaGiftService : SoapService
	...
	- (SoapRequest*) FindFriendList: (id) target action: (SEL) action key: (NSString*) key v_jsonFindUserList: (NSString*) v_jsonFindUserList;
	...
	- (SoapRequest*) GetContactList: (id) target action: (SEL) action key: (NSString*) key v_jsonContact: (NSString*) v_jsonContact;
