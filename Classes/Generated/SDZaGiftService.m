...
@implementation SDZaGiftService
	...
	/* Returns NSString*.  */
	- (SoapRequest*) FindFriendList: (id <SoapDelegate>) handler key: (NSString*) key v_jsonFindUserList: (NSString*) v_jsonFindUserList
	{
		return [self FindFriendList: handler action: nil key: key v_jsonFindUserList: v_jsonFindUserList];
	}

	- (SoapRequest*) FindFriendList: (id) _target action: (SEL) _action key: (NSString*) key v_jsonFindUserList: (NSString*) v_jsonFindUserList
		{
		NSMutableArray* _params = [NSMutableArray array];
		
		[_params addObject: [[[SoapParameter alloc] initWithValue: key forName: @"key"] autorelease]];
		[_params addObject: [[[SoapParameter alloc] initWithValue: v_jsonFindUserList forName: @"v_jsonFindUserList"] autorelease]];
		NSString* _envelope = [Soap createEnvelope: @"FindFriendList" forNamespace: self.namespace withParameters: _params withHeaders: self.headers];
		SoapRequest* _request = [SoapRequest create: _target action: _action service: self soapAction: @"http://the-asquare.com/FindFriendList" postData: _envelope deserializeTo: @"NSString"];
		[_request send];
		return _request;
	}
	...
	/* Returns NSString*.  */
	- (SoapRequest*) GetContactList: (id <SoapDelegate>) handler key: (NSString*) key v_jsonContact: (NSString*) v_jsonContact
	{
		return [self GetContactList: handler action: nil key: key v_jsonContact: v_jsonContact];
	}

	- (SoapRequest*) GetContactList: (id) _target action: (SEL) _action key: (NSString*) key v_jsonContact: (NSString*) v_jsonContact
		{
		NSMutableArray* _params = [NSMutableArray array];
		
		[_params addObject: [[[SoapParameter alloc] initWithValue: key forName: @"key"] autorelease]];
		[_params addObject: [[[SoapParameter alloc] initWithValue: v_jsonContact forName: @"v_jsonContact"] autorelease]];
		NSString* _envelope = [Soap createEnvelope: @"GetContactList" forNamespace: self.namespace withParameters: _params withHeaders: self.headers];
		SoapRequest* _request = [SoapRequest create: _target action: _action service: self soapAction: @"http://the-asquare.com/GetContactList" postData: _envelope deserializeTo: @"NSString"];
		[_request send];
		return _request;
	}
