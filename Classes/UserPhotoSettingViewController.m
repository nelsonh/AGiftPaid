...
-(void)moveViewUpAnim
{
	...
	[self.view setFrame:CGRectMake(self.view.frame.origin.x, -44, self.view.frame.size.width, self.view.frame.size.height)];
	[UIView commitAnimations];
}
...
{
	/*
	CGRect endRect=CGRectMake(1, 214, 318, originRectTextField.size.height);
